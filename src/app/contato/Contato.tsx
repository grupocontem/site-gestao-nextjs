...
export default function ContatoClient({
    ...
    formcarryContato: string;
    formcarryOuvidoria: string;
}) {
    ...
    const handleSubmitContato = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const res = await postJSON(formcarryContato, {
            nome: contato.nome,
            email: contato.email,
    ...
    const handleSubmitOuvidoria = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const res = await postJSON(formcarryOuvidoria, {
                ...
                <div className="container">
                    <div className="row">
                        <div className="container">
                                                ...
                                                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <div className="row">
                                                        <div className="cell-xl-5 height-fill" style={{ paddingTop: 30 }}>
                                                            <iframe
                                                                title="Endereço Gestão Plano de Saúde"
                            ...
                            <div className="row justify-content-center text-center py-2 pt-5" style={{ minHeight: "5vh" }}>
                                <div className="col-md-4 p-4">
                                    <h6>Rio de Janeiro (RJ)</h6>
                                    <p className="bi bi-geo-alt-fill">
                                        Rua do carmo 8, 6º andar <br /> Rio de Janeiro, RJ 20011-020
                                    </p>
                                    <p className="bi bi-envelope-fill">relacionamentocomocliente@gestaoplanodesaude.com.br</p>
                                </div>
                            </div>

                            {/* Symbols (ok manter aqui) */}
